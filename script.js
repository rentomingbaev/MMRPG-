...
function handleCommand() {
  ...
  switch (cmd) {  switch (cmd) {
    ...
    case "помощь":
      log(`
🆘 Доступные команды:
• статус – посмотреть характеристики
• бой – сразиться с монстром
• инвентарь – показать ваш инвентарь
• магазин – показать товары
• купить меч – купить меч за 50💰
• купить зелье – купить зелье за 30💰
• использовать зелье – восстановить HP
• сброс – сбросить игру
